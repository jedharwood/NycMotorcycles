                    ...
                    textDisplayPropObjects={[
                        {
                            textContent: [
                                intl.formatMessage({
                                    id: 'pg.gallery.kawasaki-h1ra.para-1',
                                }),
                                intl.formatMessage({
                                    id: 'pg.gallery.kawasaki-h1ra.para-2',
                                }),
                                intl.formatMessage({
                                    id: 'pg.gallery.kawasaki-h1ra.para-3',
                                }),
                                intl.formatMessage({
                                    id: 'pg.gallery.kawasaki-h1ra.para-4',
                                }),
                            ],
                        },
                    ]}
                    ...
                    textDisplayPropObjects={[
                        {
                            ...
                            textContent: [
                                intl.formatMessage({
                                    id: 'pg.gallery.harley-xr750-75.para-1',
                                }),
                                intl.formatMessage({
                                    id: 'pg.gallery.harley-xr750-75.para-2',
                                }),
                                intl.formatMessage({
                                    id: 'pg.gallery.harley-xr750-75.para-3',
                                }),
                                intl.formatMessage({
                                    id: 'pg.gallery.harley-xr750-75.para-4',
                                }),
                                intl.formatMessage({
                                    id: 'pg.gallery.harley-xr750-75.para-5',
                                }),
                                intl.formatMessage({
                                    id: 'pg.gallery.harley-xr750-75.para-6',
                                }),
                                intl.formatMessage({
                                    id: 'pg.gallery.harley-xr750-75.para-7',
                                }),
                                intl.formatMessage({
                                    id: 'pg.gallery.harley-xr750-75.para-8',
                                }),
                                intl.formatMessage({
                                    id: 'pg.gallery.harley-xr750-75.para-9',
                                }),
                                intl.formatMessage({
                    ...
                    textDisplayPropObjects={[
                        {
                            ...
                            textContent: [
                                ...
                                intl.formatMessage({
                                    id: 'pg.gallery.ducati-250.para-2',
                                }),
                            ],
                        },
                    ]}
            ...
            return (
                <TwoColumnGridLayout
                    ...
                    textDisplayPropObjects={[
                        {
                            title: intl.formatMessage({
                                id: 'pg.gallery.honda-dream.title',
                            }),
                            ...
                            textContent: [
                                intl.formatMessage({
                                    id: 'pg.gallery.honda-dream.para-1',
                                }),
                                intl.formatMessage({
                                    id: 'pg.gallery.honda-dream.para-2',
                                }),
                            ],
