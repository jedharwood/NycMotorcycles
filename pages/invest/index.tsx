        ...
        <>
            <HeadElement
                metaTitle={intl.formatMessage({
                    id: 'pg.invest.head.meta.title',
                })}
                metaContent={intl.formatMessage({
                    id: 'pg.invest.head.meta.content',
                })}
                    ...
                    textDisplayPropObjects={[
                        {
                            title: intl.formatMessage({
                                id: 'pg.invest.sect-1.title',
                            }),
                            textContent: [
                                intl.formatMessage({
                                    id: 'pg.invest.sect-1.text-1',
                                }),
                                intl.formatMessage({
                                    id: 'pg.invest.sect-1.text-2',
                                }),
                                intl.formatMessage({
                                    id: 'pg.invest.sect-1.text-3',
                                }),
                                intl.formatMessage({
                                    id: 'pg.invest.sect-1.text-4',
                                }),
                                intl.formatMessage({
                                    id: 'pg.invest.sect-1.text-5',
                                }),
                            ],
